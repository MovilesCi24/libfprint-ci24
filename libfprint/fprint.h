...
/* Data handling */
int fp_print_data_load(struct fp_dev *dev, int finger_code, struct fp_print_data **data);
int fp_print_data_from_dscv_print(struct fp_dscv_print *print,
	struct fp_print_data **data) LIBFPRINT_DEPRECATED;
int fp_print_data_save(struct fp_print_data *data, int finger_code);
int fp_print_data_delete(struct fp_dev *dev, int finger_code);
